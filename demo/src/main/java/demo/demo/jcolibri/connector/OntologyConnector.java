 ...
 * 07/06/2007
 */
package demo.demo.jcolibri.connector;
...
import demo.demo.jcolibri.connector.ontologyutils.OntologyInfo;
import demo.demo.jcolibri.connector.ontologyutils.OntologyMapping;
...
import demo.demo.jcolibri.util.OntoBridgeSingleton;
...
import demo.demo.jcolibri.util.*;
 ...
 * @version 2.0
 */// @see demo.demo.jcolibri.test.test10.Test10
...
public class OntologyConnector implements Connector {
	...
	public void initFromXMLfile(URL file) throws InitializingException {
		...
		try {
			...
			OntoBridge ob = demo.demo.jcolibri.util.OntoBridgeSingleton.getOntoBridge();
