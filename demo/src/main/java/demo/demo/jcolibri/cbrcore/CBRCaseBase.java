...
public interface CBRCaseBase {
     ...
     *
     */
    public void init(Connector connector) throws demo.demo.jcolibri.exception.InitializingException;
	 ...
	 */
	public Collection<demo.demo.jcolibri.cbrcore.CBRCase> getCases();
     ...
     */
    public Collection<demo.demo.jcolibri.cbrcore.CBRCase> getCases(CaseBaseFilter filter);
	 ...
	 *            to be added
	 */
	public void learnCases(Collection<demo.demo.jcolibri.cbrcore.CBRCase> cases);
