...
public class Interval implements LocalSimilarityFunction {
	 ...
	 */
	public double compute(Object o1, Object o2) throws 	demo.demo.jcolibri.exception.NoApplicableSimilarityFunctionException{
		if ((o1 == null) || (o2 == null))
			return 0;
		if (!(o1 instanceof Number))
			throw new 	demo.demo.jcolibri.exception.NoApplicableSimilarityFunctionException(this.getClass(), o1.getClass());
		if (!(o2 instanceof Number))
			throw new 	demo.demo.jcolibri.exception.NoApplicableSimilarityFunctionException(this.getClass(), o2.getClass());
