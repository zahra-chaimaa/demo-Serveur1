 ...
 * 26/06/2007
 */
package demo.demo.jcolibri.method.retrieve.NNretrieval.similarity;
...
import demo.demo.jcolibri.method.retrieve.NNretrieval.similarity.InContextLocalSimilarityFunction;
 ...
 *
 */
public abstract class StandardGlobalSimilarityFunction implements demo.demo.jcolibri.method.retrieve.NNretrieval.similarity.GlobalSimilarityFunction
{
     ...
     * @see demo.demo.jcolibri.method.retrieve.NNretrieval.similarity.GlobalSimilarityFunction#compute(CaseComponent, CaseComponent, CBRCase, CBRQuery, NNConfig)
     */
	...
	Attribute[] attributes = demo.demo.jcolibri.util.AttributeUtils.getAttributes(componentOfCase.getClass());
	...
	for(int i=0; i<attributes.length; i++)
	{
		...
		{
       		    	if(lsf instanceof  demo.demo.jcolibri.method.retrieve.NNretrieval.similarity.InContextLocalSimilarityFunction)
       		    	{
						demo.demo.jcolibri.method.retrieve.NNretrieval.similarity.InContextLocalSimilarityFunction iclsf = (InContextLocalSimilarityFunction)lsf;
