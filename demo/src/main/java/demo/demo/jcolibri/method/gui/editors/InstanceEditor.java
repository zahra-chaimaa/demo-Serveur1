...
import demo.demo.jcolibri.exception.OntologyAccessException;
...
public class InstanceEditor extends JButton implements ParameterEditor {
	...
	private static Icon INSTANCE = new javax.swing.ImageIcon(demo.demo.jcolibri.util.FileIO.findFile("/es/ucm/fdi/gaia/ontobridge/test/gui/instance.gif"));
