...
public interface FilterPredicate
{
     ...
     * @throws demo.demo.jcolibri.exception.NoApplicableFilterPredicateException if the predicate cannot be applied to those objects.
     */
    public boolean compute(Object caseObject, Object queryObject) throws demo.demo.jcolibri.exception.NoApplicableFilterPredicateException;
}
