package demo.demo.jcolibri.method.retrieve.NNretrieval.similarity.local;
...
public class Table implements LocalSimilarityFunction
{
	...
	try
	{
	    InputStream is = demo.demo.jcolibri.util.FileIO.openFile(filename);
     ...
     */
    public double compute(Object caseObject, Object queryObject) throws demo.demo.jcolibri.exception.NoApplicableSimilarityFunctionException
    {
	if ((caseObject == null) || (queryObject == null))
		return 0;
	if (! ((caseObject instanceof String)||(caseObject instanceof Enum)))
		throw new 	demo.demo.jcolibri.exception.NoApplicableSimilarityFunctionException(this.getClass(), caseObject.getClass());
	if (! ((queryObject instanceof String)||(queryObject instanceof Enum)))
		throw new 	demo.demo.jcolibri.exception.NoApplicableSimilarityFunctionException(this.getClass(), queryObject.getClass());
