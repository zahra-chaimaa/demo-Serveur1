...
public class EqualsStringIgnoreCase implements LocalSimilarityFunction {
	 ...
	 */
	public double compute(Object s, Object t) throws demo.demo.jcolibri.exception.NoApplicableSimilarityFunctionException {
		if ((s == null) || (t == null))
			return 0;
		if (!(s instanceof String))
			throw new 	demo.demo.jcolibri.exception.NoApplicableSimilarityFunctionException(this.getClass(), s.getClass());
		if (!(t instanceof String))
			throw new 	demo.demo.jcolibri.exception.NoApplicableSimilarityFunctionException(this.getClass(), t.getClass());
