 ...
 * 02/11/2007
 */
package demo.demo.jcolibri.method.gui.editors;
...
import demo.demo.jcolibri.datatypes.Instance;
import demo.demo.jcolibri.datatypes.Text;
import demo.demo.jcolibri.method.gui.editors.BooleanEditor;
import demo.demo.jcolibri.method.gui.editors.DateEditor;
import demo.demo.jcolibri.method.gui.editors.DoubleEditor;
import demo.demo.jcolibri.method.gui.editors.EnumEditor;
import demo.demo.jcolibri.method.gui.editors.FileEditor;
import demo.demo.jcolibri.method.gui.editors.InstanceEditor;
import demo.demo.jcolibri.method.gui.editors.IntegerEditor;
import demo.demo.jcolibri.method.gui.editors.ParameterEditor;
import demo.demo.jcolibri.method.gui.editors.StringEditor;
import demo.demo.jcolibri.method.gui.editors.TextEditor;
...
public class ParameterEditorFactory {
	...
	ParameterEditorFactory.registerEditor(Enum.class, demo.demo.jcolibri.method.gui.editors.EnumEditor.class);
     ...
     */
    public static demo.demo.jcolibri.method.gui.editors.ParameterEditor getEditor(Class<?> type) {
	try
	{
	    
	    Class editor = table.get(type);
	    if(editor != null)
		return (demo.demo.jcolibri.method.gui.editors.ParameterEditor)table.get(type).newInstance();
	    
	    for(Class<?> c : table.keySet())
		if(c.isAssignableFrom(type))
		    editor = table.get(c);
	    
	    if(editor.equals(demo.demo.jcolibri.method.gui.editors.EnumEditor.class))
		return new EnumEditor(type);
	    if(editor != null)
		return (demo.demo.jcolibri.method.gui.editors.ParameterEditor)editor.newInstance();
     ...
     * Creates the editor and configures it with its data-type name
     */
    public static demo.demo.jcolibri.method.gui.editors.ParameterEditor getEditor(Class<?> type, Collection<Object> allowedValues)
    {
